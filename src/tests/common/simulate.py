...
class Simulation:
    def __init__(self, controller, initial_velocity=0, desired_velocity=25):
        self.controller = controller
        self.track = Track()
        self.vehicle = Vehicle(velocity=initial_velocity)
        self.desired_velocity = desired_velocity
        self.vehicle.x, self.vehicle.y, self.vehicle.heading = self.track.get_start_pose()
        self.dt = 0.05
    ...
    def step(self):
        ...
        self.a, self.delta = self.controller.get_control(
            self.waypoints, self.vehicle.velocity
        )
        self.vehicle.update(self.a, self.dt, self.delta)
