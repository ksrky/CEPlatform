...
class Simulation:
    def __init__(self, vehicle, track, handle_controller, pedal_controller, desired_velocity=25):
        self.handle_controller = handle_controller
        self.pedal_controller = pedal_controller
        self.track = track
        self.vehicle = vehicle
        self.desired_velocity = desired_velocity
        vehicle.x, vehicle.y, vehicle.heading = track.get_start_pose()
        self.dt = 0.05
        self.traj = []
