...
interface Controller {
    get_control(waypoints: Pos[], velocity: number, wheel_base: number) : {steer: number; acc: number}
    /**
...
export class PurePursuit implements Controller {
    ...
    public get_control(waypoints: Pos[], velocity: number, wheel_base: number) : {steer: number; acc: number} {
